        ...
        if (ajx.readyState == 4 && ajx.status == 200) {
         ...
         if (ajx.readyState == 4 && ajx.status == 400) {
            ...
            if (json.wrong_password) {
                inputUsernamePassword.className = "input is-danger";
                let helper = document.createElement('p');
                helper.className = "help is-danger";
                helper.innerText = json.wrong_password;
                inputUsernamePassword.after(helper);
            } else {
                inputUsernamePassword.className = "input is-success";
            }
         }
    ...
    ajx.onreadystatechange = function () {
        if (ajx.readyState == 4 && ajx.status == 200) {
         ...
         if (ajx.readyState == 4 && ajx.status == 400) {
            ...
            if (json.wrong_password) {
                inputEmailPassword.className = "input is-danger";
                let helper = document.createElement('p');
                helper.className = "help is-danger";
                helper.innerText = json.wrong_password;
                inputEmailPassword.after(helper);
            } else {
                inputEmailPassword.className = "input is-success";
            }
         }
         if (ajx.readyState == 4 && ajx.status == 401) {
            createNotificationWrapper(ajx.responseText, 'is-dark');
        ...
        if (ajx.readyState == 4 && ajx.status == 200) {
         ...
         if (ajx.readyState == 4 && ajx.status == 400) {
            ...
            if (json.password_format) {
                inputPswd.className = "input is-danger";
                let helper = document.createElement('p');
                helper.className = "help is-danger";
                helper.innerText = json.password_format;
                inputPswd.after(helper);
            } else {
                inputPswd.className = "input is-success";
            }
            if (json.wrong_password) {
                inputPswdPassword.className = "input is-danger";
                let helper = document.createElement('p');
                helper.className = "help is-danger";
                helper.innerText = json.wrong_password;
                inputPswdPassword.after(helper);
            } else {
                inputPswdPassword.className = "input is-success";
            }
         }
         if (ajx.readyState == 4 && ajx.status == 401) {
            createNotificationWrapper(ajx.responseText, 'is-dark');
